      ...
      >
        ...
        >
          ...
          <div className="flex relative z-10 flex-col font-inter lg:gap-2 text-[#4C2C17] mb-5 lg:mb-0   mx-auto  text- ">
            <h1 className="text-7xl lg:text-9xl text-center mb-5 lg:mb-0 ">
              <span className="text-white bg-[#4C2C17]">Arti</span>kel
            </h1>
            <h3 className="text-4xl lg:text-6xl font-bold text-end">Seputar</h3>
            <h3 className="text-4xl lg:text-6xl font-bold text-end">BEM FISIP</h3>
            <Link href="/artikel" className="text-lg border-2 lg:mt-0 mt-5 border-[#4C2C17] w-fit mx-auto px-3 rounded-lg ">
              Tap Here
            </Link>
          </div>
        </main>
