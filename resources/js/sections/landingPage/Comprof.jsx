  ...
  return (
    <section className="relative w-full  bg-white">
      ...
      <main className=" relative py-20  lg:h-screen flex lg:flex-row flex-col justify-start items-center">
        <div className="lg:w-1/2 w-5/6 lg:h-4/5 h-[40vh] bg-gradient-to-l from-[#1F3A49]  via-[#4A8CAF] to-[#8EBED7]  rounded-l-2xl absolute  top-10 right-0">
          <iframe
            className="w-full aspect-video absolute top-1/2 -translate-y-1/2 right-10 lg:right-1/4 rounded-3xl"
            src="https://www.youtube.com/embed/bckuovU-M3M?si=Nu7lOQo3spFuWYJi"
