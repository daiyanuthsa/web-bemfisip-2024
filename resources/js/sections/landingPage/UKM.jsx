    ...
    <section className="w-full py-20">
      <main className="w-full relative flex lg:flex-row flex-col items-center gap-10 overflow-hidden">
        ...
        <div className="flex flex-col w-fit gap-4 font-inter items-center text-[#006181]">
          <h1 data-aos="fade-right" data-aos-duration="1000" className="text-3xl lg:text-6xl">LKM / LSO</h1>
          <h1 data-aos="fade-left" data-aos-duration="1000" className="text-6xl lg:text-8xl font-semibold">FISIP UB</h1>
        </div>
      </main>
