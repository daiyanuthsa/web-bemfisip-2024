...
const Sambutan = () => {
    ...
    return (
        <section className="flex justify-center bg-[#FAFAFA] p-4 md:p-0  items-center lg:h-screen ">
            <main className="w-full border-x-2 border-[#006181] relative gap-32 lg:gap-10 lg:border-b-2 container mx-auto lg:px-16 md:px-10 px-4 flex lg:flex-row flex-col rounded-3xl  py-32 lg:p-10">
                <div data-aos="fade-up"  className=" lg:w-2/4 relative z-30 flex flex-col justify-center items-center">
                    ...
                    <div className="flex bg-[#4C2C17] font-inter w-full p-4 rounded-2xl shadow-md text-white">
                        <div className="flex flex-col w-1/2 items-center">
                            <h1 className="lg:text-xl text-sm text-center font-semibold">Bram Adi Baskoro</h1>
                            <p className="lg:text-base text-xs text-center">Wakil Presiden BEM FISIP UB 2024</p>
                        </div>
                        <div className="flex flex-col w-1/2 items-center">
                            <h1 className="lg:text-xl text-sm text-center font-semibold">M. Rafi Haykal</h1>
                            <p className="lg:text-base text-xs text-center">Presiden BEM FISIP UB 2024</p>
                        </div>
                    </div>
                </div>
