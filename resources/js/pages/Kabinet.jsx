    ...
    <div className="bg-[#F7EDE4] font-inter">
      <header className="h-screen w-full relative flex flex-col overflow-hidden items-center justify-center gap-5">
        ...
        <p className="lg:w-3/5 w-5/6  mx-auto p-5 md:text-lg text-sm lg:text-xl border-x-2 border-b-2 border-[#805555] rounded-2xl">
          Biro Pemberdayaan Aparatur Organisasi bertanggung jawab secara
          keseluruhan mengenai internalisasi BEM FISIP UB. Aktif untuk
          memberdayakan sumber daya manusia yang disebut sebagai aparatur
          organisasi yang berlandaskan kepada visi, misi, dan nilai melalui
          budaya organisasi.
        </p>
      </header>
      <section className="flex flex-col gap-5">
        ...
        <main className="flex flex-wrap gap-2 lg:gap-5 text-center justify-center container mx-auto lg:px-16 md:px-10 px-4">
          <p className="md:text-xl text-base lg:text-2xl flex justify-center items-center font-semibold text-white bg-[#CAB9AE] rounded-2xl py-2 px-4 w-full lg:w-[47%]">
            Open Recruitment and Welcoming Staff
          </p>
        ...
        <div className="container mx-auto lg:px-16 py-10 md:px-10 px-4 flex flex-wrap-reverse justify-center gap-[5%] ">
          <div className="md:w-2/5 w-full lg:w-1/4 flex flex-col mt-5">
            ...
            <div className="w-full bg-[#D9D9D9] text-[#1F3A49] flex flex-col gap-2 rounded-3xl py-1  justify-center items-center">
                <h1 className="text-xl font-semibold">Bunga Cantika</h1>
                <p className="text-sm">Kepala Biro PAO</p>
